...
const Login = ({ setTela }) => {
    ...
    return (
        <form class='fundo  is-flex is-align-items-center is-justify-content-center '>
            <div class='is-flex is-justify-content-center'>
                <img src={logo} class='is-centered pb-6' alt="" />
            </div>
            <div class='tela-login is-flex is-justify-content-center' style={{
                backgroundColor: 'rgba(217, 217, 217, 0.2)', width: '80%', height: '60%',
            }}>
                <div class='field-login is-justify-content-center m-auto'>
                    ...
                    <div>
                        ...
                        <input class="input-cinza mb-6 is-medium is-flex-grow-4 is-rounded" type="text" placeholder='Digite seu E-mail' style={{ width: '100%' }} onChange={(e) => setEmail(e.target.value)} required/>
                    </div>
                    <div>
                        <p className='mt-2 ml-6 is-size-4 has-text-weight-medium entra'>Senha</p>
                        <input class="input-cinza mb-6 is-medium is-flex-grow-4 is-rounded" type="password"  placeholder='Digite sua Senha' style={{ width: '100%' }} onChange={(e) => setSenha(e.target.value)} required/>
                    </div>
