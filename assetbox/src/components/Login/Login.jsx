...
const Login = ({ setTela }) => {
    ...
    return (
        <form className='fundo h-screen is-flex is-align-items-center is-justify-content-center '>
            ...
            <div className='tela-login is-flex is-justify-content-center' style={{
                backgroundColor: 'rgba(217, 217, 217, 0.2)', width: '80%', height: '60%',
            }}>
                <div className='field-login is-justify-content-center m-auto'>
                    ...
                    <div>
                        ...
                        <input className="input-cinza mb-6 is-medium is-flex-grow-4 is-rounded" type="text" placeholder='Digite seu E-mail' style={{ width: '100%' }} onChange={(e) => setEmail(e.target.value)} required/>
                    </div>
                    <div>
