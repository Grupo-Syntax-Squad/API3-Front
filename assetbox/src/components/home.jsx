    ...
    return(
        <div className='logo-container'>
          ...
          <div className="modal-content">
              ...
              <img src={AlertIcon} className='container image is-96x96' alt="AssetBox Logo"/>
                  <p className='has-text-weight-bold'>Faltam X dias para a expiração do ativo X. Renove ou agende uma manutenção!</p>
                  <button class="delete is-pulled-right" aria-label="close" onClick={fecharAlerta}></button>
              </div>
