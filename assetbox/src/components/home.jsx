    ...
    useEffect(() => {
        axios.get('http://localhost:8000/ativos')
            .then(response => {
                ...
                setShowAlerta(ativosProximosDeExpirar.length > 0);
            })
            .catch(error => {
    ...
    return (
        <div className='logo-container h-screen'>
            ...
            <div className="help-button">
                <button className="shadow-button button button-effect is-primary m-5 ml-6 is-size-4 ajuda-botao" onClick={() => setShowPopup(true)}>?</button>
